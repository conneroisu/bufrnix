...
Go support includes the complete Protocol Buffer ecosystem with all major plugins and performance optimizations.
...
| Plugin                    | Description           | Generated Files    |
| ------------------------- | --------------------- | ------------------ |
| **`protoc-gen-validate`** | Legacy validation     | `*.pb.validate.go` |
| **`protovalidate`**       | Modern CEL validation | Runtime validation |
