...
<Tabs>
<TabItem label="Data Science APIs">
...
<TabItem label="Add External Dependencies">
...
<CardGrid stagger>
  <Card title="Data Science" icon="chart">
  ...
  <Card title="Microservice Focus" icon="server">
    Process only relevant service definitions per microservice
  </Card>
  <Card title="Third-Party APIs" icon="puzzle">
