...
/**
 * A JSON client that implements the {@see HelloService} interface.
 ...
 */
final class HelloServiceJsonClient extends HelloServiceAbstractClient implements HelloService
{
    /**
     * @inheritDoc
     */
