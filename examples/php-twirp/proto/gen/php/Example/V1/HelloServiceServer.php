 ...
 */
final class HelloServiceServer implements RequestHandlerInterface
{
    /**
     ...
     *
     * Use HelloServiceServer::getPathPrefix instead.
     */
    public const PATH_PREFIX = '/twirp/example.v1.HelloService/';
    ...
    {
        return $this->prefix.'/example.v1.HelloService/';
    }
    ...
    public function handle(ServerRequestInterface $req): ResponseInterface
    {
        ...
        if ($service != 'example.v1.HelloService') {
    ...
    private function handleHelloJson(array $ctx, ServerRequestInterface $req): ResponseInterface
    {
        ...
        try {
            ...
            $in = new \Example\V1\HelloRequest();
