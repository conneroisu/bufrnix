{
  ...
  outputs = inputs @ {flake-utils, ...}:
    flake-utils.lib.eachDefaultSystem (system: let
      ...
      bufrnixOptionsSchema = with pkgs.lib; {
        # Basic configuration
        root = mkOption {
          type = types.str;
          default = "./proto";
      ...
      # Default configuration with actual values (not option types)
      defaultConfig = {
        root = "./proto";
        debug = {
          enable = false;
      ...
      nixosModule = {
        ...
        options.bufrnix = bufrnixOptionsSchema;
    ...
    in {
      ...
      lib = {
        bufrnixSchema = bufrnixOptionsSchema;
        bufrnixDefaults = defaultConfig;
